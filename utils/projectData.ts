export const projectFiles = {
  ...
  "logo.svg": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 80">
  <defs>
    <linearGradient id="limeGrad" x1="0" x2="1" y1="1" y2="0">
  ...
  <style>
    .text { font-family: 'Arial Black', 'Impact', sans-serif; font-weight: 900; font-style: italic; fill: url(#limeGrad); }
  </style>
  <text x="5" y="30" font-size="24" class="text" letter-spacing="-1">THE</text>
  <text x="5" y="70" font-size="52" class="text" letter-spacing="-3" filter="url(#glow)">GLEZ</text>
</svg>`,
